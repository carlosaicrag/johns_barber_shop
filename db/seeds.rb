...
client_haircut_user3 = ClientHaircut.create!(client_id: client3.id, haircut_id: haircut1.id, barber_id: barber2.id, started_haircut_time: DateTime.current)
client_haircut_user4 = ClientHaircut.create!(client_id: client4.id, haircut_id: haircut2.id, barber_id: barber3.id, started_haircut_time: DateTime.current) 

...
client_haircut_user7 = ClientHaircut.create!(client_id: client1.id, haircut_id: haircut3.id,barber_id: barber3.id, closed_at: DateTime.now, started_haircut_time: DateTime.now)
client_haircut_user8 = ClientHaircut.create!(client_id: client1.id, haircut_id: haircut4.id,barber_id: barber3.id, closed_at: DateTime.now, started_haircut_time: DateTime.now)

...
class ClientProfileIndex extends React.Component {
  ...
  componentDidMount() {
    this.props.fetchClients(this.props.match.params.id).then(() => {
  ...
  render() {
    ...
    return (
      <div className="profile-container">
        <ClientProfileHeader client={this.props.client} />
        <ClientProfileHaircutIndex clientHaircuts={this.props.clientHaircuts} />
      </div>
    );
  }
}
